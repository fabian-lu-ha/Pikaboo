# notion://custom_emoji/a5f8ef90-fb04-40dc-94f0-244a17cb37f2/3156dbf0-dcd7-80b9-8433-007a1a3d04de Big Berlin Hack Hackathon Manual
🏆
...
▶ **Viral Video Content Challenge - [https://forms.techeurope.io/bbh/content-challenge](https://forms.techeurope.io/bbh/content-challenge)**
  It wins the channel with the most combined total views across platforms. You need to tag the respective {Tech: Europe} account on the platform.
Location: ‣ [Donaustraße 44, 12043 Berlin](https://maps.app.goo.gl/mKxJ5hJ715cDv6Ju5)
Hosts : ‣[The Delta Campus](https://thedelta.io/campus/berlin) & ‣ [Code University of Applied Sciences](http://code.berlin)

📝
  Book your 20 min Legal Office Hours slot with [PXR](https://pxr.law/en) from 2pm to 4pm  👉  [https://forms.techeurope.io/bigberlinhack/office-hours](https://forms.techeurope.io/bigberlinhack/office-hours)
...
#### [Buena](https://website-git-dev-hiring.preview.buena.com/dev) - 🏗️ The Context Engine
🏆 Track Prize: €2500
▶ **[Challenge](https://website-git-dev-hiring.preview.buena.com/dev)**
...
The world’s top EV seller in units, still treated like the outsider brand in many markets. Build something that helps BYD own more of the conversation around EVs in the channels where buyers are making decisions.
  Docs: [https://docs.peec.ai/mcp/introduction](https://docs.peec.ai/mcp/introduction)
...
#### 1st Place
- 🤑🤑🤑 €10k cash 🤑🤑🤑
- 5k USD Gemini Credits
- 10k Tavily Credits
- 900k Gradium Credits
- Pioneer Pro plan (1 month)

#### 2nd Place
- 2.5k USD Gemini Credits
- 5k Tavily Credits
- 600k Gradium Credits
- Pioneer Pro plan (1 month)

#### 3rd Place
- 1k USD Gemini Credits
- 3k Tavily Credits
...
▶ **[Tavily](https://www.tavily.com/) - Real-time search, extraction, research, and web crawling through a single, secure API**
  ...
  -  Docs: [https://docs.tavily.com/welcome](https://docs.tavily.com/welcome)
▶ **[Lovable](http://lovable.dev) - Create apps and websites by chatting with AI → Code: COMM-BIG-PVDK**
  ...
  1. If you don't have an account, click on “Get started” → Create an account.
  1. If you have an account, go to Settings → Plans & Credits.
  1. Select Pro Plan 1 (100 credits). Make sure to choose the monthly plan.
  1. At checkout, enter your discount code: COMM-BIG-PVDK
...
▶ **[Entire ](https://entire.io/?utm_source=luma)- Developer platform for agent-human collaboration**
  Install tool with commands found here: [https://docs.entire.io/cli/installation](https://docs.entire.io/cli/installation)
...
▶ **[Pioneer](https://pioneer.ai/) by [Fastino](https://fastino.ai/) - Models that train themselves**
  Check out their Big Berlin Hack onboarding page [here](https://wholesale-mackerel-22f.notion.site/Big-Berlin-Hack-Onboarding-3498413d474480319020ddb593d700c0?pvs=74).
